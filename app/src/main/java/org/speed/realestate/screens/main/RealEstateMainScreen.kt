...
fun RealEstateMainScreen(
    ...
    var showAddRealEstateSheet by remember { mutableStateOf(false) }
    ...
    Scaffold(
        topBar = {
            RealEstateTopBar(onRegisterClick = {
                showAddRealEstateSheet = true
            })
        },
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun RealEstateTopBar(onRegisterClick: () -> Unit) {
